...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>CodeAbode : Advanced Javascript Course</title>
            ...
            <div class="courseArchive_content">              
             <div class="singlecourse_ferimg_area">
               <div class="singlecourse_ferimg">
                 <img src="/img/course_logo/advanced.jpg" alt="img">
               </div>  
             ...
             <div class="single_course_content">
               <h2>About our Advanced Javascript Course</h2>
               <h3>Course Description</h3>

<p>This CodeAbode course is designed to teach advanced JavaScript concepts in service of creating web applications. We will be taking the fundamental programming & web concepts from the last class as our starting point.</p>

<p>In the first half of the class, we will be using object-oriented programming (OOP) to structure larger programs that interact with real world data (via APIs).  In the second half of the class, we will be using our web programming skills to build hybrid applications - web applications that can be deployed to the App Store and Google Play store.</p>

<h3>Course Roadmap</h3>

<p>Day 1: Review & Objects in p5</p>

<p>Day 2: More Object-Oriented Programming</p>

<p>Day 3: More Object-Oriented Programming</p>
<p>Day 4: Advanced DOM techniques</p>

<p>Day 5: Application Programming Interfaces (APIs) – weather, music info and nutrition</p>

<p>Day 6: Application Programming Interfaces (APIs) – weather, music info and nutrition</P>

<p>Day 7: Single Page Apps (SPAs)</p>

<p>Day 8: Browser Storage (localHistory)</p>

<p>Day 9: Movie Search & Favorite App (with Movie Database API)</p>

<p>Day 10: PhoneGap & PhoneGap Plugins</p>
              ...
              <div class="single_blog_prevnext">
                <a href="./javascript.php" class="prev_post wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;"><i class="fa fa-angle-left"></i>Previous</a>
                <a href="./server.php" class="next_post wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">Next<i class="fa fa-angle-right"></i></a>
              </div>
          </div>
<!--===================== End course content -->
