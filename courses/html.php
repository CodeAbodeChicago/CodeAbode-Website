...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>CodeAbode : HTML/CSS Course</title>
            ...
            <div class="courseArchive_content">              
             <div class="singlecourse_ferimg_area">
               <div class="singlecourse_ferimg">
                 <img src="/img/course_logo/html_small.jpg" alt="img">
              </div>  
             ...
             <div class="single_course_content">
               <h2>About our HTML/CSS Course</h2>
               <p>This course will cover the essentials of modern web site design and development, using HTML5 and CSS3.  Students will be exposed to the entire development pipeline, including early research and planning, wire framing, selecting a final design, and production.  The focus of the course will be on developing strong foundational knowledge of “raw” HTML and CSS.  From there, students can expand their skills using any of the popular web development frameworks.</p>
               <p>A single course can't hope to teach everything about HTML & CSS.  The most important skill you need in the technical world is the ability to problem solve and teach yourself. The lessons and assignments in these classes are structured around building that skill.</p>
               <h3>Prerequisits</h3>
               <p>An enthusiastic attitude towards learning and increasing your potential</p>
               <h3>Course Roadmap</h3>
               <p>Day 1: Course Overview & Foundational Concepts</p>
               <p>Day 2: Presentations & HTML Images/Lists</p>
               <p>Day 3: Introduction to Styling (CSS)</p>
               <p>Day 4: Box Model & Positioning</p>
               <p>Day 5: Color & Typography</p>
               <p>Day 6: Forms & Student Conferences</p>
               <p>Day 7: Tables</p>
               <p>Day 8: CSS Animation</p>
               <p>Day 9: Final Presentations</p>
               <p>Day 10: Advanced Topics</p>
              ...
              <div class="single_blog_prevnext">
                ...
                <a href="./javascript.php" class="next_post wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">Next<i class="fa fa-angle-right"></i></a>
              </div>
          </div>
<!--===================== End course content -->
