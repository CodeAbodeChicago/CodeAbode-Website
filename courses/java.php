            ...
            <div class="courseArchive_content">              
             <div class="singlecourse_ferimg_area">
               <div class="singlecourse_ferimg">
                 <img src="../img/course_logo/java.png" alt="img">
               </div>  
             ...
             <div class="single_course_content">
               <h2>About our Java Course</h2>
               <p>Starting from the grounding of programming concepts learned via JavaScript, students will be introduced to the basics of systems programming as used in Java. Topics will include data types, type casting, basic math operations, working with text strings and arrays. Java's approach to object-oriented programming will be presented. The relationship between classes and objects, object fields and methods, encapsulation and inheritance will be covered. The Android Studio development environment will be adapted for use in creating and authoring Java projects, in order to ease the transition to Android programming.</p>
               <h3>Course Roadmap</h3>


<p>"classic" object orientation</p>
<p>variable and object typing</p>
<p>structuring a program with classes and packages</p>
<p>working with an IDE (integrated development environment)</p>
<p>preparation for Android programming</p>
              ...
              <div class="single_blog_prevnext">
                <a href="./server.php" class="prev_post wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;"><i class="fa fa-angle-left"></i>Previous</a>
                <a href="./android.php" class="next_post wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">Next<i class="fa fa-angle-right"></i></a>
              </div>
          </div>
<!--===================== End course content -->
