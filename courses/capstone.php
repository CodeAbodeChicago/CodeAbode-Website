...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>CodeAbode : Capstone Course</title>
            ...
            <div class="courseArchive_content">              
             <div class="singlecourse_ferimg_area">
               <div class="singlecourse_ferimg">
                 <img src="../img/course_logo/capstone.jpg" alt="img">
               </div>  
             ...
             <div class="single_course_content">
               <h2>About our Capstone Course</h2>
               <p>In this class, you will be proposing and working on a project of your choosing.You will go through a formal planning & design process with feedback and guidance from mentors.</p>
               <p>This class is mainly about the “soft,” fuzzy skills of programming, as opposed to the“hard,” concrete skills (e.g. knowing JS & Java syntax). Specifically, we’re concerned with building these four skills:</p>

                  <h4> - Communication</h4>
                  <h4> - Time management</h4>
                  <h4> - Problem solving</h4>
                  <h4> - Independent learning</h4>

              <h3>Course Roadmap</h3>

<p>Day 1: Introduction & Project Brainstorming</p>
<p>Day 2: Setting Milestones & Design</p>
<p>Day 3: Mockups</p>
<p>Day 4: Implementation</p>
<p>Day 5: Implementation</p>
<p>Day 6: Progress Report Presentations</p>
<p>Day 7: Revising Milestones & Incorporating Feedback</p>
<p>Day 8: Implementation</p>
<p>Day 9: Implementation</p>
<p>Day 10: Final Presentations</p>
              ...
              <div class="single_blog_prevnext">
                <a href="./android.php" class="prev_post wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;"><i class="fa fa-angle-left"></i>Previous</a>
              </div>
          </div>
<!--===================== End course content -->
