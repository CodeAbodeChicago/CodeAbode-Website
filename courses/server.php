...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>CodeAbode : Server Side Course</title>
            ...
            <div class="courseArchive_content">              
             <div class="singlecourse_ferimg_area">
               <div class="singlecourse_ferimg">
                 <img src="../img/course_logo/server.png" alt="img">
               </div>  
             ...
             <div class="single_course_content">
               <h2>About our Server Side Course</h2>
               <h3>Course Description</h3>

<p>This course focuses on servers: computers that communicate over a network. While there are a variety of server side programming languages to choose from, we will be focusing on Node.js. Node is a relatively new framework that allows us to write JavaScript code outside of the browser. This allows us to create servers using the skills that we already have!</p>

<p>We will be starting with "vanilla" node to learn the basics. From there, we will use begin using third-party libraries in node, starting with Express - a library for simplifying network communication. Then we will cover real time interactions with Socket.IO. And finally, we will how to store persistent data in a MongoDB database.</p>

<h3>Course Roadmap</h3>

<p>Day 1: Terminal & Node Basics</p>

<p>Day 2: File Input/Output in Node</p>

<p>Day 3: Creating an HTTP Server in Node</p>
<p>Day 4: More HTTP in Node</p>

<p>Day 5: Express Framework</p>

<p>Day 6: Real Time Communication (Socket.IO)</p>

<p>Day 7: Real Time Whiteboard App (Front-end)</p>

<p>Day 8: Real Time Whiteboard App (Back-end)</p>

<p>Day 9: Real Time Chat App</p>
...
<p>Day 10: MongoDB</p>
              ...
              <div class="single_blog_prevnext">
                <a href="./advanced.php" class="prev_post wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;"><i class="fa fa-angle-left"></i>Previous</a>
                <a href="./java.php" class="next_post wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">Next<i class="fa fa-angle-right"></i></a>
              </div>
          </div>
<!--===================== End course content -->
