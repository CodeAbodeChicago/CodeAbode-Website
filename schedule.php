...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>CodeAbode : Upcoming classes</title>
...
<!-- top title -->
              <div class="title_area">
                <h2 class="title_two">Bootcamps</h2>
                <span></span> 
...
<!-- start single blog archive -->
                  ...
                  <div class="single_structure_archive wow fadeInUp">
                    ...
                    <!-- <div class=""> -->
                        ...
                        <h3>January Web Programmer Bootcamp</h3>
                          ...
                          <h4>Server-Side</h4>
                          <br>
                          <p>Bootcamp classes run:<br><i class="fa fa-clock-o"></i> Monday - Thursday  •  10:00am - 3:00pm<br>
      ...
      <!-- NEXT IS INPUTTING THE MORAINE VALLEY BOOTCAMP -->
                    ...
                    <p>
                      ...
                      <h4>HTML/CSS</h4>
                          ...
                          <p>Bootcamp classes run:<br><i class="fa fa-clock-o"></i> Monday - Thursday  •  11:00am - 4:00pm<br>
                            <i class="fa fa-calendar"></i>Jan 25, 2016 – May 13, 2016 
                            <br>This includes a week off for Spring Break, & a make-up week for other MVCC holidays and institute days<br>
                            Cost: $3600</p>
                  ...
                  <div class="title_area">
                <h2 class="title_two">Evening Courses*</h2>
                <span></span> 
